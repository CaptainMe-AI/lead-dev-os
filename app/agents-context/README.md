...
Task groups generated by `/step2-scope-tasks` automatically include **"Read before starting"** directives that list exactly which concept and standard files to load.
